...
<div class="panel-body mtop10">
      ...
      <div class="col-md-8 text-right show_quantity_as_wrapper">
         <div class="mtop10">
            ...
            <div class="radio radio-primary radio-inline">
               <input type="radio" value="1" id="1" name="show_quantity_as" data-text="<?php echo _l('surveyor_table_quantity_heading'); ?>" <?php if(isset($surveyor) && $surveyor->show_quantity_as == 1){echo 'checked';}else{echo'checked';} ?>>
               <label for="1"><?php echo _l('quantity_as_qty'); ?></label>
            </div>
            <div class="radio radio-primary radio-inline">
               <input type="radio" value="2" id="2" name="show_quantity_as" data-text="<?php echo _l('surveyor_table_hours_heading'); ?>" <?php if(isset($surveyor) && $surveyor->show_quantity_as == 2){echo 'checked';} ?>>
               <label for="2"><?php echo _l('quantity_as_hours'); ?></label>
            </div>
            <div class="radio radio-primary radio-inline">
               <input type="radio" id="3" value="3" name="show_quantity_as" data-text="<?php echo _l('surveyor_table_quantity_heading'); ?>/<?php echo _l('surveyor_table_hours_heading'); ?>" <?php if(isset($surveyor) && $surveyor->show_quantity_as == 3){echo 'checked';} ?>>
               <label for="3"><?php echo _l('surveyor_table_quantity_heading'); ?>/<?php echo _l('surveyor_table_hours_heading'); ?></label>
            </div>
         </div>
      </div>
   </div>
   <div class="table-responsive s_table">
      <table class="table surveyor-items-table items table-main-surveyor-edit has-calculations no-mtop">
         <thead>
            <tr>
               <th></th>
               <th width="20%" align="left"><i class="fa fa-exclamation-circle" aria-hidden="true" data-toggle="tooltip" data-title="<?php echo _l('item_description_new_lines_notice'); ?>"></i> <?php echo _l('surveyor_table_item_heading'); ?></th>
               <th width="25%" align="left"><?php echo _l('surveyor_table_item_description'); ?></th>
               <?php
                  ...
                  } else if(isset($surveyor) && $surveyor->show_quantity_as == 3){
               ...
               <th width="15%" align="right"><?php echo _l('surveyor_table_rate_heading'); ?></th>
               <th width="20%" align="right"><?php echo _l('surveyor_table_tax_heading'); ?></th>
               <th width="10%" align="right"><?php echo _l('surveyor_table_amount_heading'); ?></th>
         ...
         <tbody>
            ...
            <?php if (isset($surveyor) || isset($add_items)) {
               ...
               $table_row .= '<td class="taxrate">' . $this->misc_model->get_taxes_dropdown_template('' . $items_indicator . '[' . $i . '][taxname][]', $surveyor_item_taxes, (isset($is_proposal) ? 'proposal' : 'surveyor'), $item['id'], true, $manual) . '</td>';
   ...
   <div class="col-md-8 col-md-offset-4">
      <table class="table text-right">
         <tbody>
            <tr id="subtotal">
               <td><span class="bold"><?php echo _l('surveyor_subtotal'); ?> :</span>
               </td>
               <td class="subtotal">
               </td>
            </tr>
            <tr id="discount_area">
               <td>
                  <div class="row">
                     <div class="col-md-7">
                        <span class="bold"><?php echo _l('surveyor_discount'); ?></span>
                     </div>
                     <div class="col-md-5">
                        <div class="input-group" id="discount-total">

                           <input type="number" value="<?php echo (isset($surveyor) ? $surveyor->discount_percent : 0); ?>" class="form-control pull-left input-discount-percent<?php if(isset($surveyor) && !is_sale_discount($surveyor,'percent') && is_sale_discount_applied($surveyor)){echo ' hide';} ?>" min="0" max="100" name="discount_percent">

                           <input type="number" data-toggle="tooltip" data-title="<?php echo _l('numbers_not_formatted_while_editing'); ?>" value="<?php echo (isset($surveyor) ? $surveyor->discount_total : 0); ?>" class="form-control pull-left input-discount-fixed<?php if(!isset($surveyor) || (isset($surveyor) && !is_sale_discount($surveyor,'fixed'))){echo ' hide';} ?>" min="0" name="discount_total">
                           ...
                           <div class="input-group-addon">
                              <div class="dropdown">
                                 ...
                                 <ul class="dropdown-menu" id="discount-total-type-dropdown" aria-labelledby="dropdown_menu_tax_total_type">
                                   <li>
                                    <a href="#" class="discount-total-type discount-type-percent<?php if(!isset($surveyor) || (isset($surveyor) && is_sale_discount($surveyor,'percent')) || (isset($surveyor) && !is_sale_discount_applied($surveyor))){echo ' selected';} ?>">%</a>
                                  </li>
                                  <li>
                                    <a href="#" class="discount-total-type discount-type-fixed<?php if(isset($surveyor) && is_sale_discount($surveyor,'fixed')){echo ' selected';} ?>">
            ...
            <tr>
               <td>
                  <div class="row">
                     <div class="col-md-7">
                        <span class="bold"><?php echo _l('surveyor_adjustment'); ?></span>
                     </div>
                     <div class="col-md-5">
                        <input type="number" data-toggle="tooltip" data-title="<?php echo _l('numbers_not_formatted_while_editing'); ?>" value="<?php if(isset($surveyor)){echo $surveyor->adjustment; } else { echo 0; } ?>" class="form-control pull-left" name="adjustment">
                     </div>
                  </div>
               </td>
            ...
            <tr>
               <td><span class="bold"><?php echo _l('surveyor_total'); ?> :</span>
               </td>
               <td class="total">
               </td>
            </tr>

                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="form-group no-mbot">
                            ...
                            <input type="checkbox" id="include_shipping" name="include_shipping" <?php if(isset($surveyor) && $surveyor->include_shipping == 1){echo 'checked';} ?>>
                            <label for="include_shipping"><?php echo _l('shipping_address'); ?></label>
                        </div>
                      </div>
                        <div id="shipping_details" class="<?php if((isset($surveyor) && $surveyor->include_shipping != 1) || !isset($surveyor)){echo 'hide';} ?>">
                        <div class="form-group">
                                <div class="checkbox checkbox-primary checkbox-inline">
                                <input type="checkbox" id="show_shipping_on_surveyor" name="show_shipping_on_surveyor" <?php if((isset($surveyor) && $surveyor->show_shipping_on_surveyor == 1) || !isset($surveyor)){echo 'checked';} ?>>

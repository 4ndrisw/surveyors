...
class Staff extends AdminController
{
  ...
  //      $this->load->model('pengguna_model');
    ...
    public function add($client_id)
    {
        ...
        hooks()->do_action('surveyor_member_add_view_profile');
        ...
        if ($this->input->post()) {
            ...
            if ($id) {
                ...
                redirect(admin_url('surveyors/staff/member/' . $id));
            }
        }
        ...
        $data['title']         = $title;
        $this->load->view('admin/surveyors/staff/member', $data);
    }
    ...
    public function timesheets()
    {
        ...
        if ($this->input->is_ajax_request()) {
            $this->app->get_table_data(module_views_path('surveyors','staff_timesheets', ['view_all' => $data['view_all']]));
        }
    ...
    public function delete()
    {
        ...
        redirect(admin_url('surveyors/staff'));
    }
    ...
    public function edit_profile()
    {
        ...
        if ($this->input->post()) {
            ...
            redirect(admin_url('surveyors/staff/edit_profile/' . get_staff_user_id()));
        }
    ...
    public function remove_staff_profile_image($id = '')
    {
        ...
        if (!is_numeric($id)) {
            redirect(admin_url('surveyors/staff/edit_profile/' . $staff_id));
        } else {
            redirect(admin_url('surveyors/staff/member/' . $staff_id));
        }
    }
    ...
    public function change_password_profile()
    {
        if ($this->input->post()) {
            ...
            redirect(admin_url('surveyors/staff/edit_profile'));
        }
    }
            ...
            foreach ($notifications as $notification) {
                if (($notification['fromcompany'] == null && $notification['fromuserid'] != 0) || ($notification['fromcompany'] == null && $notification['fromclientid'] != 0)) {
                    if ($notification['fromuserid'] != 0) {
                        $notifications[$i]['profile_image'] = '<a href="' . admin_url('surveyors/staff/profile/' . $notification['fromuserid']) . '">' . staff_profile_image($notification['fromuserid'], [
    ...
    public function table()
    {
        ...
        $this->app->get_table_data(module_views_path('surveyors', 'tables/staff'));
    }
}
